...
print(sys.path)
import setproctitle
setproctitle.setproctitle('test_UM@maruolong')
import argparse
import torch
import os
import json
...
def eval_model(args):
    ...
    import pickle
    with open("/data3/maruolong/segregation/Train/UrbanMLLM/cross_train/31/data2/feature_vector_segregation_test.pkl",'wb') as file:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_new_tokens", type=int, default=8600)
