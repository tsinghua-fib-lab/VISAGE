...
class LlavaMetaModel(ABC):
    ...
    def encode_images(self, images,images_num):
        image_features = self.get_vision_tower()(images)
        #image_features = self.resampler(image_features, images_num)
        
        image_features = self.get_mm_projector()(image_features,images_num)
...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        self, input_ids, position_ids, attention_mask, past_key_values, labels, images,images_num
    ):
        ...
        image_features = self.encode_images(images,images_num).to(self.device)
