...
class LlavaLlamaModel(LlavaMetaModel, LlavaMetaForCausalLM, PreTrainedModel):
    ...
    def forward(
        ...
        images_num: Optional[torch.LongTensor] = None,
        ...
        temp = self.generate(
            ...
            attention_mask=attention_mask[:,:130],
            do_sample=True,
            temperature=0.2,
            top_p =None,
            num_beams = 1,
        ...
        if inputs_embeds is None:
            (
                ...
                input_ids, position_ids, attention_mask, past_key_values, labels, images,images_num
            )
        ...
        **generation_kwargs,
        ...
        if images is not None:
            (
                ...
                input_ids, None, attention_mask, None, None, images,images_num
            )
        else:
