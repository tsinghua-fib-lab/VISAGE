...
torchrun --nnodes=$n_node --nproc_per_node=5 --master_port=25005 \
    ...
    --version llama_3 \
    --data_mixture segregation_cot_40_31_data2 \
    ...
    --bf16 True \
    --output_dir /data3/maruolong/VISAGE/data/cross_train/31/segregation_cot_40_31_data2/vila_train_all_sisv_pretrain_textenhance_att_clean_8B_new  \
    --num_train_epochs 1 \
