...
sys.path.append("/data3/maruolong/VISAGE/agents/perception_agent/inference")

# -----------------------------
# Import Modules
# -----------------------------
from pipeline_main import LiteratureAnalysisPipeline
from experiment_agent_run import experiment_agent_run
from visage_complete_pipeline import VISAGECompletePipeline
...
default_paths = {
    ...
    # "codebook_path": "/data3/maruolong/VISAGE/agents/data/codebooks.json",  
    # Knowledge base codebook used in literature agent

    "rs_cue_detection": "/data3/maruolong/VISAGE/data/rs_image_cue_detection_results.jsonl",  
    # Remote sensing cue detection results

    "street_cue_detection_base": "/data3/maruolong/VISAGE/data/street_view_cue_detection",  
    # Folder containing street view cue detection results

    "rs_aggregated_desc": "/data3/maruolong/VISAGE/data/rs_aggregated_description_by_tract.jsonl",  
    # Aggregated remote sensing description by tract

    "street_aggregated_desc": "/data3/maruolong/VISAGE/data/aggregated_description_by_tract.jsonl",  
    # Aggregated street view description by tract

    "original_qa": "/data3/maruolong/VISAGE/data/31_original_qa.json",  
    # Original QA dataset

    "final_qa_with_caption": "/data3/maruolong/VISAGE/data/31_qa_with_caption.json"  
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_data_dir", type=str, default="/data3/maruolong/VISAGE/data/processed/training_data/cross_train/31", help="Base folder for training data")
...
python run_visage_pipeline.py --run_experiment --cities "NYC,LA,Chicago"

# Generate K-fold datasets for training and optionally run regression visualization
python run_visage_pipeline.py --generate_datasets --k_fold 5 --run_regression_viz
...
2. Demographic & Segregation Data
   - Urban area demographic data JSON:
       * `json1_path` 
