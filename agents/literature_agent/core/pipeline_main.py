...
1. Command Line Usage:
   ...
   python pipeline_main.py --workflow full
   
   # Run specific workflow only
   python pipeline_main.py --workflow curator
   python pipeline_main.py --workflow extractor  
   python pipeline_main.py --workflow coder
   
   # Custom data directory
   python pipeline_main.py --workflow full --base_dir /path/to/your/data
...
2. Python Script Usage:
   ...
   # Initialize pipeline
   pipeline = LiteratureAnalysisPipeline(base_dir="/data3/maruolong/VISAGE/data/processed/literature")
