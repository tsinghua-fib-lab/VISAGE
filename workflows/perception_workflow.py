...
1. COMPLETE PIPELINE (All Steps):
   python perception_workflow.py --generate-datasets --run-training --run-inference

2. DATASET GENERATION ONLY:
   python perception_workflow.py --generate-datasets
...
================================================================================
    ...
    parser.add_argument("--input-path", default="/data3/maruolong/VISAGE/data/processed/training_data/31_qa_with_caption.json",
    ...
    parser.add_argument("--base-output-dir", default="/data3/maruolong/VISAGE/data/processed/training_data/cross_train/31",
